package com.base.common.dyquery;
...
public class Conditions {
    ...
    public void setFiledQuery(String QueryType, String... filedName) {
        if (StringUtil.isNoNullorEmpty(QueryType) && !Common.isNullOrEmpty(filedName)) {
    ...
    public void setValueQuery(String QueryType, String fieldName, Object filedValue) {
        if (StringUtil.isNoNullorEmpty(QueryType) && StringUtil.isNoNullorEmpty(fieldName) && !Common.isNullOrEmpty(filedValue)) {
    ...
    public void modelToCondition(Model<?> modelClass, String alias) {
        alias = StringUtil.isNoNullorEmpty(alias) ? alias + "." : "";
        if (modelClass != null) {
            // 所有的字段
                        ...
                        if (!"GLOBALTYPE".equals(queryType)) {
                            for (Object field : array) {
                                ...
                                if (!excludeFieldMap.get().containsKey(filedName)) {
                                    ...
                                    if(EMPTY.equals(queryType) || NOT_EMPTY.equals(queryType)){
                                        fieldValue = null;
                                    }
                                    // 将设置过的字段保存到数组中
