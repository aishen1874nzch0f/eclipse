...
<link href="${ctx}/styles/css/select.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="${ctx}/styles/js/jquery.js"></script>
<script type="text/javascript" src="${ctx}/styles/js/jquery.idTabs.min.js"></script>
<script type="text/javascript" src="${ctx}/styles/js/select-ui.min.js"></script>
<script type="text/javascript" src="${ctx}/styles/editor/kindeditor.js"></script>
