...
public class MenuValidator extends Validator {
	...
	protected void validate(Controller controller) {
		validateRequiredString("res.name", "nameMsg", "请输入菜单名称!");
	}
	...
	protected void handleError(Controller controller) {
		...
		if (actionKey.equals("/shiro/menu/save"))
			controller.render("resAdd.jsp");
		else if (actionKey.equals("/shiro/menu/update"))
			controller.render("resEdit.jsp");
	}
}
